...
of this theme.  One of them is \\( \LaTeX \\) via MathJax{{% sidenote %}}Ceci est une side note. Lorem ipsum dolor sit amen.{{% /sidenote %}} 
...
### Inline
Some inline math:  {{%marginnote "mn-example" %}} This is a margin note. {{% /marginnote %}}  
